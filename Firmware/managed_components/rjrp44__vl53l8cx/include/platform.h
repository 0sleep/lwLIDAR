...
/*
 * @brief Structure VL53L8CX_Platform contains the vl53l8cx address and
 * the I2C port used.
 */
...
#ifndef CONFIG_VL53L8CX_NB_TARGET_PER_ZONE
#define VL53L8CX_NB_TARGET_PER_ZONE 1U
#else
#define VL53L8CX_NB_TARGET_PER_ZONE CONFIG_VL53L8CX_NB_TARGET_PER_ZONE
#endif
...
#ifdef CONFIG_VL53L8CX_DISABLE_AMBIENT_PER_SPAD
        #define VL53L8CX_DISABLE_AMBIENT_PER_SPAD
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_NB_SPADS_ENABLED
        #define VL53L8CX_DISABLE_NB_SPADS_ENABLED
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_NB_TARGET_DETECTED
        #define VL53L8CX_DISABLE_NB_TARGET_DETECTED
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_SIGNAL_PER_SPAD
        #define VL53L8CX_DISABLE_SIGNAL_PER_SPAD
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_RANGE_SIGMA_MM
        #define VL53L8CX_DISABLE_RANGE_SIGMA_MM
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_DISTANCE_MM
        #define VL53L8CX_DISABLE_DISTANCE_MM
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_REFLECTANCE_PERCENT
        #define VL53L8CX_DISABLE_REFLECTANCE_PERCENT
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_TARGET_STATUS
        #define VL53L8CX_DISABLE_TARGET_STATUS
#endif

#ifdef CONFIG_VL53L8CX_DISABLE_MOTION_INDICATOR
        #define VL53L8CX_DISABLE_MOTION_INDICATOR
#endif
